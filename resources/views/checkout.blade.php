                    ...
                    <div class="cart-detail bg-light p-3 p-md-4">
                        <h3 class="billing-heading mb-4">Payment Method</h3>
                                  <div class="form-group">
                                      <div class="col-md-12">
                                          <div class="radio">
                                             <label><input type="radio" name="payment_method"value="bank_transfer" class="mr-2"> Direct Bank Tranfer</label>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <p><form action="{{ Route('placeorder') }}" method="POST">
                                    @csrf
                                    <button type="submit" class="btn btn-primary py-3 px-4">Place an order</button></form></p>
                              </div>
                </div>
            </div>
        </div> <!-- .col-md-8 -->
