              ...
              <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                 ...
                 <div class="panel panel-default">
                     ...
                     <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                         <div class="panel-body">
                            <ul>
                                 <li><a href="{{ Route('filterproducts',['category_id'=>11]) }}">Watches</a></li>
                                 <li><a href="{{ Route('filterproducts',['category_id'=>12]) }}">Sun glasses</a></li>
                                 <li><a href="{{ Route('filterproducts',['category_id'=>13]) }}">Belts</a></li>
                                 <li><a href="{{ Route('filterproducts',['category_id'=>14]) }}">Jewellery</a></li>
                             </ul>
                         </div>
                     </div>
                 </div>
                 <div class="panel panel-default">
                     ...
                     <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                         <div class="panel-body">
                            <ul>
                                 <li><a href="{{ Route('filterproducts',['category_id'=>15]) }}">Jeans</a></li>
                                 <li><a href="{{ Route('filterproducts',['category_id'=>16]) }}">T-Shirt</a></li>
                                 <li><a href="{{ Route('filterproducts',['category_id'=>17]) }}">Jacket</a></li>
                                 <li><a href="{{ Route('filterproducts',['category_id'=>18]) }}">Track suits</a></li>
                             </ul>
                         </div>
                     </div>
                 </div>
